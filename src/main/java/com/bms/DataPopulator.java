...
public class DataPopulator {
	...
	public ResponseEntity<String> generate() {
		...
		MovieEntity spidermanMovie = getMovie("Spiderman", MovieLanguage.ENGLISH, Genre.HORROR, LocalDate.now());
		MovieEntity batmanMovie = getMovie("Batman", MovieLanguage.ENGLISH, Genre.HORROR, LocalDate.now().minusDays(1));
	...
	private MovieEntity getMovie(String name, MovieLanguage language, Genre genre, LocalDate releaseDate) {
